...
# Ensure gawk is used instead of mawk for regex compatibility
# The Codex installer requires gawk for interval expressions in regex
if command -v gawk >/dev/null 2>&1 && command -v update-alternatives >/dev/null 2>&1; then
